...
RSpec.describe "Outings Show Page", type: :feature do
  describe "As a visitor" do
    ...
    it "can see outings information" do
      ...
      expect(page).to have_content("Count of Contestants: #{@outing_1.contestants.count}")
